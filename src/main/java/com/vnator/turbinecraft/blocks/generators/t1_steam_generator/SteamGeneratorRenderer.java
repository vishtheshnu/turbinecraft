...
public class SteamGeneratorRenderer extends TileEntityRenderer<SteamGeneratorTile> {

    public SteamGeneratorRenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
        super(rendererDispatcherIn);
    }

    @Override
    public void render(SteamGeneratorTile tile, float partialTicks, MatrixStack matrix, IRenderTypeBuffer buffer, int light, int overlay) {
    ...
    public static void register(){
        ClientRegistry.bindTileEntityRenderer(Registration.BASIC_STEAM_GENERATOR_TILE, SteamGeneratorRenderer::new);
    }
}
